...
export default async function handler(req, res) {
  ...
  try {
    ...
    const receiptHTML = generateReceiptHTML({
      ...
      phase1Amount: phase1Amount.toFixed(2),
      phase2Amount: phase2Amount.toFixed(2),
      totalAmount: totalAmount.toFixed(2),
      phase1Description: `Phase 1: ${waitlistComms?.length || 0} verified waitlist signups`,
      phase2Description: `Phase 2: ${subComms?.length || 0} active subscriptions`
    });
...
<body>
    ...
    <div class="details-grid">
        <div class="detail-section">
            ...
            <p>
                ...
                <strong>Date Paid:</strong> ${new Date(data.paymentDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}<br>
    ...
    <div class="amount-banner">
        <div class="label">Amount Paid on ${new Date(data.paymentDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</div>
