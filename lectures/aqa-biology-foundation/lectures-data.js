// AQA Combined Science: Biology (Foundation Tier) — lectures-data.js
// Rebuilt from the real generated lecture files already in the repo, using the same
// verified real AQA Trilogy Biology topic structure as the Higher tier build:
// Paper 1 = Topics 1-4, Paper 2 = Topics 5-7.
    ...
    pillars: [
      ...
      },
      {
        ...
        lectures: [
          ...
          { slug: "sci-bio-p4-l10-the-bodys-response-to-exercise", title: "The Bodys Response to Exercise" },
