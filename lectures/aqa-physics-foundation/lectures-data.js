// AQA Combined Science: Physics (Foundation Tier) — lectures-data.js
// Rebuilt from real generated lecture files, same verified topic structure as Higher:
// no Foundations/Working Scientifically section (Physics-only pillars).
// Paper 1 = Energy/Electricity/Particle Model/Atomic Structure (topics 18-21).
// Paper 2 = Forces/Waves/Magnetism and Electromagnetism (topics 22-24).
